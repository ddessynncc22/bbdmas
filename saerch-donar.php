...
<body>
	...
	<div class="container">
		<div class="search-container">
			<form name="donar" method="post" class="row g-3">
				<div class="col-md-4">
				...
				<div class="col-md-4 d-flex align-items-end">
					<button type="submit" name="sub" class="btn btn-request">Search Donors</button>
				</div>
			</form>
		</div>
		...
		if(isset($_POST['sub'])) {
			...
			if($query->rowCount() > 0) { ?>
				<div class="row">
						...
						<div class="col-md-4">
							<div class="donor-card">
								...
								<div class="donor-info">
									...
									<a href="contact-blood.php?cid=<?php echo $result->id;?>" class="btn btn-request">Request Blood</a>
								</div>
							</div>
						</div>
					<?php }
					...
					<div class="col-12">
						<div class="no-records">No donors found matching your criteria.</div>
					</div>
				<?php }
			} ?>
		</div>
